...
def check_timeout():
    ...
    if elapsed >= 135:
        print(f"found.py reached 135-second timeout (elapsed: {elapsed:.1f}s). Exiting...")
...
if __name__ == "__main__":
    try:
        ...
        print(f"Starting found.py at {check_timeout():.1f}s")
        time.sleep(4)
        check_timeout()
        ...
        print(f"found.py completed successfully at {check_timeout():.1f}s")
        sys.exit(0)

    except Exception as e:
        print(f"Error in found.py: {e}")
